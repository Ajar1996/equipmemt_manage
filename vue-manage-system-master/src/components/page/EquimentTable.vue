    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
				...
				<el-button type="primary" icon="el-icon-plus" @click="handleSave()">新增设备</el-button>
            </div>
            <el-table
                :data="tableData"
                border
            ...
            >
				...
				<el-table-column prop="brandId" label="型号"></el-table-column>
		...
		<el-dialog title="详情" :visible.sync="detailVisible" width="30%">
		    <el-form ref="form" :model="form" label-width="70px">
				...
				<el-select v-model="form.brandId" placeholder="请选择设备型号">
				      <el-option v-for="brand in brandList"  :label="brand.brandName" :key="brand.id" :value="brand.id"></el-option>
				</el-select>
				</el-form-item>
		...
		<el-dialog title="详情" :visible.sync="editSave" width="30%">
			<el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
			  ...
			  <el-select v-model="ruleForm2.brandId" placeholder="请选择设备型号">
			        <el-option v-for="brand in brandList"  :label="brand.brandName" :key="brand.id" :value="brand.id"></el-option>
			  </el-select>
			  </el-form-item>
			  <el-form-item>
...
export default {
    ...
    methods: {
        getData(pageIndex,name) {
			...
			axios({
			  method: 'get',
			  url: 'api/admin/selectEquipmentList',
			  params:{
				  name:name,
				  page:pageIndex
			  }
		...
		submitForm2(formName) {
		        this.$refs[formName].validate((valid) => {
		          ...
		          if (valid) {			  
					axios({
					  method: 'post',
					  url: 'api/admin/saveEquipment',
					  data: {
						name: this.ruleForm2.name,
						brandId:this.ruleForm2.brandId
					  },
					})
					  .then(function (response) {					  
						if(response.data.code==0){
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(() => {
					...
					axios({
					  method: 'delete',
					  url: 'api/admin/deleteEquipment/'+row.id,
